...
-		define('PHYSICAL_PATH',$_SERVER['DOCUMENT_ROOT'].'/lendingtree/');
	...
	{
		$config['base_url']	= 'http://' . $_SERVER['SERVER_NAME']. '/bayequity/';
		define('BASE_URL','http://'.$_SERVER['HTTP_HOST'].'/bayequity/');
		define('PHYSICAL_PATH',$_SERVER['DOCUMENT_ROOT'].'/bayequity/');
	}
//$config['base_url'] = '';
