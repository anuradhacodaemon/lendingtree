...
require_once(__DIR__.'/../third_party/google-api-php-client/src/Google/autoload.php');

class Customanalytcsclass {

    private $service_account_email = NULL;
    private $key_file_location = NULL;

    function __construct() {
	$serviceacc_email = 'culoan@culoanportal.iam.gserviceaccount.com';
	$key_file_path = __DIR__.'/../third_party/culoanportal-6f16109abcb7.p12';
    ...
    public function getSessonData() {
        ...
        $data = $analytics->data_ga->get(
                'ga:' . $profileId, '30daysAgo', 'today', 'ga:sessions,ga:users,ga:newUsers,ga:bounceRate,ga:sessionDuration,ga:avgSessionDuration,ga:hits,ga:visits');
        $rowdata = $data->getRows();
