               ...
               <tr>
                ...
                <tr>
                    ...
                    <?php $p_city=$userDetails['p_city'];
                        ...
                        if($p_city>0)
                                                            {
                                                          $city_data=$this->Autoloanmccu_model->get_city_value($p_city);
                ...
                <tr>
                    ...
                    <?php 
                        $p_state=$userDetails['p_state'];
                                                            if($p_state>0)
                                                            {
                                                          $state_data=$this->Autoloanmccu_model->get_state_value($p_state);
            ...
            <table>
                ...
                <tr>
                    ...
                    <?php // echo $r_city;
                        ...
                        if($r_city>0)
                        {
                      $r_city_data=$this->Autoloanmccu_model->get_city_value($r_city);
                ...
                <tr>
                    ...
                    if($r_state>0)
                          {
                        $r_state_data=$this->Autoloanmccu_model->get_state_value($r_state);
            ...
            <td>
                ...
                <tr>
                    ...
                    <?php // echo $co_city;
                         $co_p_city=$userDetails['co_p_city'];
                                                if($co_p_city>0)
                                                {
                                              $co_p_city_data=$this->Autoloanmccu_model->get_city_value($co_p_city);
                ...
                <tr>
                    ...
                    <?php // echo $co_state;
                        ...
                        if($co_p_state>0)
                        {
                      $co_p_state_data=$this->Autoloanmccu_model->get_state_value($co_p_state);
