        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
                <div class="form-main home-loan clearfix">
                    <h1 class="text-head">Have you or your spouse served in the military?</h1>
                    <!--<a href="" class="disclosure-sec">Disclosures</a>-->
                    <div class="clearfix"></div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="offer-cont">
                            <a href="javascript:void(0);" onclick="home_step14(1)">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="offer-cont">
                            <a href="javascript:void(0);" onclick="home_step15(2)">
                                <button class="offer-circ">
                                    <div class="outer-circ">
                                        <div class="inner-bevel">
                                            <div class="second-bevel">
