  ...
  <div class="container">
    ...
    <div class="offer-main clearfix">
      <div class="offer-cont">
        <a href="<?php echo BASE_URL . 'auto?step=1' ?>" onClick="ga('send', 'event', 'MCT', 'click', 'auto loan');">
      ...
      <div class="offer-cont">
        <a href="<?php echo BASE_URL . 'refinance?refinancestep=1' ?>"
          onClick="ga('send', 'event', 'MCT', 'click', 'auto refinance');">
          <button class="offer-circ">
            <div class="outer-circ">
              <div class="inner-bevel">
                <div class="second-bevel">
      ...
      <div class="offer-cont">
        <a href="<?php echo BASE_URL . 'homeloan?homeloan=1' ?>"
          onClick="ga('send', 'event', 'MCT', 'click', 'home loan');">
          <button class="offer-circ">
            <div class="outer-circ">
              <div class="inner-bevel">
                <div class="second-bevel">
    ...
    <div class="center-btns">
      <div class="offer-cont">
        <a href="<?php echo BASE_URL . 'loancalculator' ?>"
          onClick="ga('send', 'event', 'MCT', 'click', 'loan calculator');">
          <button class="offer-circ">
            <div class="outer-circ">
              <div class="inner-bevel">
                <div class="second-bevel">
      ...
      <div class="offer-cont">
        <a href="<?php echo BASE_URL . 'mortgagecalculator' ?>"
          onClick="ga('send', 'event', 'MCT', 'click', 'mortgage calculator');">
          <button class="offer-circ">
            <div class="outer-circ">
              <div class="inner-bevel">
                <div class="second-bevel">
    ...
    <div class="row">
        ...
        <a href="">
          <div class="click-box effect-sadie">
            <span class="icon-ring">
              <img src="<?php echo BASE_URL; ?>public/html/img/mortgage-rate.svg" class="img-responsive" />
            </span>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="">
          <div class="click-box text-center padding40 white effect-sadie">
            <span class="icon-ring">
              <img src="<?php echo BASE_URL; ?>public/html/img/mortgage-calculator.svg" class="img-responsive" />
            </span>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="">
          <div class="click-box text-center padding40 white effect-sadie">
            <span class="icon-ring">
              <img src="<?php echo BASE_URL; ?>public/html/img/rating.svg" class="img-responsive" />
            </span>
