    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2 col-xs-12">
                <div class="offer-cont">
                    <a href="<?php echo BASE_URL . 'loancalculator' ?>" onClick="ga('send', 'event', 'sw-financial', 'click', 'loan calculator');" >
                        <button class="offer-circ">
                            <div class="outer-circ">
                                <div class="inner-bevel">
                                    <div class="second-bevel">
			...
			<div class="col-md-3 col-sm-4 col-xs-12">
                <div class="offer-cont">
                    <a href="<?php echo BASE_URL . 'mortgagecalculator' ?>" onClick="ga('send', 'event', 'sw-financial', 'click', 'mortgage calculator');" >
                        <button class="offer-circ">
                            <div class="outer-circ">
                                <div class="inner-bevel">
                                    <div class="second-bevel">
