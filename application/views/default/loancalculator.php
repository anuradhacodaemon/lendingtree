                    ...
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-12 marg_5 bg">
                            ...
                            <div class="radio-main">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    <!--<input type="radio" name="type" /> -->
                                    <label class="radio-container"><?php echo $loandetails[0]['bank'] ?>%
                        ...
                        <div class="col-xs-12 col-sm-12 marg_5 bg clearfix"> 
                            ...
                            <div class="col-xs-4 col-sm-4 col-lg-4 col-md-4 radio">
                                <div  class="label-text width_auto" id="total_interest1">$ <span id="interest_pay1">0</span></div>
                            </div>
                            <div class="col-xs-4 col-sm-4 col-lg-4 col-md-4 radio">
                                <div  class="label-text width_auto" id="total_interest2">$ <span id="interest_pay2">0</span></div>
                            </div>
                            <div class="col-xs-4 col-sm-4 col-lg-4 col-md-4 radio">
                                <div  class="label-text width_auto" id="total_interest3">$ <span id="interest_pay3">0</span></div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
