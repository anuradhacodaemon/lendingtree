<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left admin-location-select-module" method="post" action="<?php echo base_url('admin/state/store'); ?>">
                    <div class="alert">
