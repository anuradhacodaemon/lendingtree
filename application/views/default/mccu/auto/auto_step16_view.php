        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              ?>
                    ...
                    <label class="control-label">Are you an united states citizen or permanent resident of the united states?</label>
                    <div class="row">
                    <form id="other_than_us_citizen" method="POST">
                            ...
                            <div class="col-xs-12 col-sm-12 radio">
                                ...
                                <input type="radio" value="yes" name="other_than_us_citizen"  onclick="CitizenOtherThanUS(16, 'yes')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                            </div>
                            <div class="col-xs-12 col-sm-12 radio">
                                <label <?php if(isset($this->session->userdata['a_u_s_citizen_permanant_alien'])) { if($this->session->userdata['a_u_s_citizen_permanant_alien']== 'N') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                                    ...
                                    <span class="continueIcon sprites"></span>
                                <input type="radio" value="no" name="other_than_us_citizen" onclick="CitizenOtherThanUS(16, 'no')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                            </div>
