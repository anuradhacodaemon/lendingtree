                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="auto_step" value="8" id="auto_step" >
                            <div class="col-lg-12 col-md- col-sm-12 col-xs-12">
                                ...
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <label>Street</label>
                                    <input type="text" name="p_r_street_line" placeholder="Street" value="<?php if (isset($this->session->userdata['p_r_street_line'])) echo $this->session->userdata['p_r_street_line'] ?>" class="form-control width_100" id="p_r_street_line" >
                                </div>
                                <div class="col-xs-12 col-sm-6 margbot_10">
                                    <label>Country</label>
                                    <input type="text" name="p_r_country" placeholder="Country" value="<?php if (isset($this->session->userdata['p_r_country'])) echo $this->session->userdata['p_r_country'] ?>" class="form-control width_100" id="p_r_country" >
                                </div>
                                <div class="col-xs-12 col-sm-6 margbot_10">
                                    <label>State</label>
                                    <input type="text" name="p_r_state" placeholder="State" value="<?php if (isset($this->session->userdata['p_r_state'])) echo $this->session->userdata['p_r_state'] ?>" class="form-control width_100" id="p_r_state" >
                                </div>
                                <div class="col-xs-12 col-sm-6 margbot_10">
                                    <label>City</label>
                                    <input type="text" name="p_r_city" placeholder="City" value="<?php if (isset($this->session->userdata['p_r_city'])) echo $this->session->userdata['p_r_city'] ?>" class="form-control width_100" id="p_r_city" >
                                </div>
                                <div class="col-xs-12 col-sm-6 margbot_10">
                                    <label>Zipcode</label>
                                    <input type="text" name="p_r_zip_code" placeholder="Zipcode" value="<?php if (isset($this->session->userdata['p_r_zip_code'])) echo $this->session->userdata['p_r_zip_code'] ?>" class="form-control width_100" id="p_r_zip_code" >
                                </div>
