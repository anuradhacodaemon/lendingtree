                        ...
                        <form id="p_details" method="post" onsubmit="return getFormId(this)">
                            ...
                            <div class="input-text">
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <input type="text" name="cosigner_monthly_pay" placeholder="Monthly Pay $##,###.##" value="<?php if (isset($this->session->userdata['cosigner_monthly_pay'])) echo $this->session->userdata['cosigner_monthly_pay'] ?>" class="form-control width_100" id="cosigner_monthly_pay_auto" >
