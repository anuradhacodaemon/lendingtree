              ...
              ?>
                    ...
                    <form id="miltry_involve" method="POST">
                        ...
                        <div class="col-xs-12 col-sm-12 radio">
                            ...
                            <input type="radio" value="Active" name="miltary_involve"  onclick="miltaryInvolve('Active')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                        </div>
                        <div class="col-xs-12 col-sm-12 radio">
                            <label <?php if(isset($this->session->userdata['military_involvement'])) { if($this->session->userdata['military_involvement']== 'Former') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                                ...
                                <span class="continueIcon sprites"></span>
                            <input type="radio" value="Former" name="miltary_involve" onclick="miltaryInvolve('Former')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                        </div>
                        <div class="col-xs-12 col-sm-12 radio">
                            <label <?php if(isset($this->session->userdata['military_involvement'])) { if($this->session->userdata['military_involvement']== 'None') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                                ...
                                <span class="continueIcon sprites"></span>
                            <input type="radio" value="None" name="miltary_involve" onclick="miltaryInvolve('None')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                        </div>
