                ...
                <div class="form-main clearfix">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <input type="text" name="phone" placeholder="phone" value="<?php if (isset($this->session->userdata['phone'])) echo $this->session->userdata['phone'] ?>" class="form-control width_100" id="phone" maxlength="10">
