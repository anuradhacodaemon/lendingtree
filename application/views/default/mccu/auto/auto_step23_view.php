          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <h1>
              ...
              <div class="col-xs-12 col-sm-12 radio">
                  ...
                  <input type="radio" value="Buying" name="co_home_status"  onclick="getHomeRadioBtn(26, 'Buying')" class="ng-pristine ng-invalid ng-invalid-required"></label>
              </div>
              <div class="col-xs-12 col-sm-12 radio">
                  <label <?php if(isset($this->session->userdata['cosigner_own_rent'])) { if($this->session->userdata['cosigner_own_rent']== 'Own') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                    ...
                    <span class="continueIcon sprites"></span>
                  <input type="radio" value="Own" name="co_home_status" onclick="getHomeRadioBtn(26, 'Own')" class="ng-pristine ng-invalid ng-invalid-required"></label>
              </div>
              <div class="col-xs-12 col-sm-12 radio">
                  <label <?php if(isset($this->session->userdata['cosigner_own_rent'])) { if($this->session->userdata['cosigner_own_rent']== 'Rent') echo 'class="button status"'; else echo 'class=button';} else echo 'class=button'; ?>>
                    ...
                    <span class="continueIcon sprites"></span>
                  <input type="radio" value="Rent" name="co_home_status" onclick="getHomeRadioBtn(26, 'Rent')" class="ng-pristine ng-invalid ng-invalid-required"></label>
              </div>
              </
          </div>
          </div>
