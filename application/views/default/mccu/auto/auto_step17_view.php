                    ...
                    <div class="row">
                        <form id="bankruptcy_adjustmnt" method="POST">
                            ...
                            <div class="col-xs-12 col-sm-12 radio">
                                ...
                                <input type="radio" value="yes" name="bankruptcy_adjustmnt"  onclick="BankruptcyJudge('yes')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                            </div>
                            <div class="col-xs-12 col-sm-12 radio">
                                <label <?php if(isset($this->session->userdata['bankruptcy_debt_adjusutment'])) { if($this->session->userdata['bankruptcy_debt_adjusutment']== 'N') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                                    ...
                                    <span class="continueIcon sprites"></span>
                                <input type="radio" value="no" name="bankruptcy_adjustmnt" onclick="BankruptcyJudge('no')" class="ng-pristine ng-invalid ng-invalid-required"></label>
                            </div>
