        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-main clearfix">
                    <h1>Haroon Buying New Vehicle</h1>
                    ...
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['type']))
                            ...
                            <input type="radio" value="NewCarPurchase" name="type_loan"  onclick="TypeOfLoan(1)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['type'])) { if($this->session->userdata['type']== 2) echo 'class="button status"'; else echo 'class=button';} else  echo 'class="button"';?>>
                            ...
                            <span class="continueIcon sprites"></span>
                            <input type="radio" value="UsedCarPurchase" name="type_loan" onclick="TypeOfLoan(2)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['type'])) { if($this->session->userdata['type']== 3) echo 'class="button status"'; else echo 'class=button';} else  echo 'class="button"'; ?>>
                            ...
                            <span class="continueIcon sprites"></span>
                            <input type="radio" value="Refinance" name="type_loan" onclick="TypeOfLoan(3)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                    </form>
                </div>
            </div>
