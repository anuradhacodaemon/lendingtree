          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <h1>
              ...
              <div class="col-xs-12 col-sm-12 radio">
                  ...
                  <input type="radio" value="yes" name="p_another_source"  onclick="anotherSourceIncome('yes')" class="ng-pristine ng-invalid ng-invalid-required"></label>
              </div>
              <div class="col-xs-12 col-sm-12 radio">
                  <label <?php if(isset($this->session->userdata['laid_off_for_payment_waived'])) { if($this->session->userdata['laid_off_for_payment_waived']== 'N') echo 'class="button status"'; else echo 'class=button';}else echo 'class=button'; ?>>
                    ...
                    <span class="continueIcon sprites"></span>
                  <input type="radio" value="no" name="p_another_source" onclick="anotherSourceIncome('no')" class="ng-pristine ng-invalid ng-invalid-required"></label>
              </div>
