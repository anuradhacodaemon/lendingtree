                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <input type="text" name="address" placeholder="Enter Address" value="<?php if (isset($this->session->userdata['address'])) echo $this->session->userdata['address'] ?>" class="form-control width_100" id="address" >
                                <span id="err1" style="color: red"></span>

                            </div>

                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <input type="text" name="living_there_years" placeholder="Years Been There" value="<?php if (isset($this->session->userdata['living_there_years'])) echo $this->session->userdata['living_there_years'] ?>" class="form-control width_100" id="living_there_years" >
                            ...
                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <div class="form-main clearfix">   
                                    ...
                                    <div class="slider-box">
                                        <input id="ex6" name="monthly_pay" type="text" data-slider-min="0" data-slider-max="5000" data-slider-step="25" data-slider-value="<?php echo (!empty($this->session->userdata['currently_owe']))?$this->session->userdata['currently_owe']:5000 ;
                ?>"/> 
