              ...
              ?>
                    ...
                    <form id="co_work_details" method="POST" onsubmit="return getFormId(this)">
                        ...
                        <div class="col-lg-12 col-md- col-sm-12 col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <input type="text" name="cosigners_working_years" pattern="(?!0$)([1-9]\d?|0[1-9])" placeholder="Years You Have Worked Here?" value="<?php if (isset($this->session->userdata['cosigner_how_long_working_years'])) echo $this->session->userdata['cosigner_how_long_working_years'] ?>" class="form-control width_100" id="cosigners_working_years" >
