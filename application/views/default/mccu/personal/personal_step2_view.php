            ...
            <div class="form-main clearfix">
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 margbot_10">
                    <input type="text" name="p_req_amt" placeholder="Enter Requested Amount" value="<?php if (isset($this->session->userdata['requested_amount'])) echo $this->session->userdata['requested_amount'] ?>" class="form-control" id="p_req_amt">
