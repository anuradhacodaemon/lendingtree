                    ...
                    <form id="co_user_docs" method="POST" onsubmit="return getFormId(this)">
                        ...
                        <div class="col-lg-12 col-md- col-sm-12 col-xs-12">
                            ...
                            <span style = "color:black;"> $ </span>
                                <input type="text" name="cosigner_monthly_income_pre_tax" placeholder="List Income Source" value="<?php if (isset($this->session->userdata['cosigner_monthly_income_pre_tax'])) echo $this->session->userdata['cosigner_monthly_income_pre_tax'] ?>" class="form-control width_100" id="cosigner_monthly_income_pre_tax" >
