                    ...
                    <div class="row">
                      ...
                      <!--    <div class="input-text">
                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <input type="text" name="address" placeholder="Home Address" value="<?php if (isset($this->session->userdata['address_p'])) echo $this->session->userdata['address_p'] ?>" class="form-control width_100" id="auto_primary_address_id" >
                       ...
                       <span id="err5" style="color: red"></span>
                        ...
                        <div class="input-text">
                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <input type="text" name="monthly_pay" placeholder="Monthly Payment Amount" value="<?php if (isset($this->session->userdata['monthly_pay'])) echo $this->session->userdata['monthly_pay'] ?>" class="form-control width_100" id="monthly_pay_personal" >
