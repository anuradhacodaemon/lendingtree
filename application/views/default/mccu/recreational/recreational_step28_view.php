                    ...
                    <form id="co_relative" method="POST" onsubmit="return getFormId(this)">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-12 margbot_10">
                                <label>Street</label>
                                <input type="text" name="co_r_street_line" placeholder="Street" value="<?php if (isset($this->session->userdata['co_r_street_line'])) echo $this->session->userdata['co_r_street_line'] ?>" class="form-control width_100" id="co_r_street_line" >
                            </div>
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <label>Country</label>
                                <input type="text" name="co_r_country" placeholder="Country" value="<?php if (isset($this->session->userdata['co_r_country'])) echo $this->session->userdata['co_r_country'] ?>" class="form-control width_100" id="co_r_country" >
                            </div>
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <label>State</label>
                                <input type="text" name="co_r_state" placeholder="State" value="<?php if (isset($this->session->userdata['co_r_state'])) echo $this->session->userdata['co_r_state'] ?>" class="form-control width_100" id="co_r_state" >
                            </div>
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <label>City</label>
                                <input type="text" name="co_r_city" placeholder="City" value="<?php if (isset($this->session->userdata['co_r_city'])) echo $this->session->userdata['co_r_city'] ?>" class="form-control width_100" id="co_r_city" >
                            </div>
                            <div class="col-xs-12 col-sm-6 margbot_10">
                                <label>Zipcode</label>
                                <input type="text" name="co_r_zip_code" placeholder="Zipcode" value="<?php if (isset($this->session->userdata['co_r_zip_code'])) echo $this->session->userdata['co_r_zip_code'] ?>" class="form-control width_100" id="co_r_zip_code" >
                            </div>
