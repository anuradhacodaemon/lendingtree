        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              ?>
                    ...
                    <label class="control-label">Joint Owner/Co-Signer's Address Details</label>
                    <div class="row">
                        ...
                        <div class="input-text">
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <input type="text" name="cosigner_monthly_pay" placeholder="Monthly Payment" value="<?php if (isset($this->session->userdata['cosigner_monthly_pay'])) echo $this->session->userdata['cosigner_monthly_pay'] ?>" class="form-control width_100" id="cosigner_monthly_pay" >
...
<script> //$('input[name=amount]').val()
    ...
    //
    $(document).ready(function() {
        $('#cosigner_monthly_pay').on('blur', function() {
            $("#err3").html("");
