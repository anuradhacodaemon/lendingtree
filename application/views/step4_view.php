            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-main clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 margbot_40">
                        <input  type="text" id="pre_tax_income" name="pre_tax_income" value="<?php if (!empty($this->session->userdata['pre_tax_income'])) { echo '$'.number_format($this->session->userdata['pre_tax_income']); } ?>" class="form-control"  >
