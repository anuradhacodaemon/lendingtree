...
<script src="<?php echo BASE_URL; ?>public/js/vscsteps.js"></script>
...
<div class="modal fade" id="disclosureModal" tabindex="-1" role="dialog" aria-labelledby="disclosureModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="disclosure">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h5>By providing the Credit Union with a wireless phone number (cell phone) you consent to receiving
          phone calls, including autodialed and pre-recorded calls from the Credit Union or its third-party
          debt collector at that number. </h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
