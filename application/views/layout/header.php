      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-5 col-sm-6 col-xs-7">
            <div class="logo">
              <a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>public/html/img/logo_1.png" alt="Logo" title="UFCW Local 23 Federal Credit Union" class="img-responsive"/></a>
            </div>
          </div>
