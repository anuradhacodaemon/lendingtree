                                    ...
                                    <div class="outer-circ">
                                        <div class="inner-bevel">
                                            <div class="second-bevel">
                                                <div class="offer-img offer-purchase_house"></div>
                            ...
                            <a href="javascript:void(0);" onclick="home_step2(1)">
                                <button class="offer-circ">
                                    <div class="outer-circ">
                                        <div class="inner-bevel">
                                            <div class="second-bevel">
                                                <div class="offer-img offer-refinance_house"></div>
                            ...
                            <a href="javascript:void(0);" onclick="home_step2(1)">
                                <button class="offer-circ">
                                    <div class="outer-circ">
                                        <div class="inner-bevel">
                                            <div class="second-bevel">
                                                <div class="offer-img offer-home_equity_house"></div>
                            ...
                            <a href="javascript:void(0);" onclick="home_step2(1)">
                                <button class="offer-circ">
                                    <div class="outer-circ">
                                        <div class="inner-bevel">
                                            <div class="second-bevel">
                                                <div class="offer-img offer-reverse_mtg_house"></div>
