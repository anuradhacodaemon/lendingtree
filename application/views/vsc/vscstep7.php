                ...
                <div class="form-main clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['basic_warranty']))
                            ...
                            <input type="radio" value="NewCarPurchase"  onclick="vscstep8(1)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['basic_warranty'])) { if($this->session->userdata['basic_warranty']== 2) echo 'class="button status"'; else echo 'class=button';} else  echo 'class="button"';?>>
                            ...
                            <span class="continueIcon sprites"></span>
                            <input type="radio" value="NewCarPurchase" onclick="vscstep8(2)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                </div>
            </div>
        </div>
