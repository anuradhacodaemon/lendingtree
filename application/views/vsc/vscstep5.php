                ...
                <div class="form-main clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['is_purchased']))
                            ...
                            <input type="radio" value="NewCarPurchase"  onclick="vscstep6(1)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                    <div class="col-xs-12 col-sm-12 radio">
                        <label <?php if(isset($this->session->userdata['is_purchased'])) { if($this->session->userdata['is_purchased']== 2) echo 'class="button status"'; else echo 'class=button';} else  echo 'class="button"';?>>
                            ...
                            <span class="continueIcon sprites"></span>
                            <input type="radio" value="NewCarPurchase" onclick="vscstep6(2)" class="ng-pristine ng-invalid ng-invalid-required"></label>
                    </div>
                </div>
            </div>
        </div>
