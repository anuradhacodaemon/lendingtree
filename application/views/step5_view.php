                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="input-text">
                                ...
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <!--<label>Street</label>-->
                                    <input type="hidden" name="p_street_line" placeholder="Street"
                                        value="<?php if (isset($this->session->userdata['street_line'])) echo $this->session->userdata['street_line'] ?>"
                                        class="form-control width_100" id="street_name">
                                </div>
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <!--<label>City</label>-->
                                    <input type="hidden" name="p_city" placeholder="City"
                                        value="<?php if (isset($this->session->userdata['city'])) echo $this->session->userdata['city'] ?>"
                                        class="form-control width_100" id="city_name">
                                </div>
                            </div>
                            <div class="input-text">
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <!--<label>State</label>-->
                                    <input type="hidden" name="p_state" placeholder="State"
                                        value="<?php if (isset($this->session->userdata['state'])) echo $this->session->userdata['state'] ?>"
                                        class="form-control width_100" id="state_name">
                                </div>
                                <div class="col-xs-12 col-sm-12 margbot_10">
                                    <!--<label>Zipcode</label>-->
                                    <input type="hidden" name="p_zip_code" placeholder="Zipcode"
                                        value="<?php if (isset($this->session->userdata['zip'])) echo $this->session->userdata['zip'] ?>"
                                        class="form-control width_100" id="zipcode_name">
                                </div>
                            </div>
