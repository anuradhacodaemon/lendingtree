        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-main clearfix">
              ...
              <div class="col-xs-12 col-sm-12 margbot_10">
                <input type="text" name="city" placeholder="City" value="<?php if(isset($this->session->userdata['userdata']['city'])) echo $this->session->userdata['userdata']['city']?>" class="form-control" id="city" >
              </div>
              <span id="err4" style="color: red"></span>
              <div class="col-xs-12 col-sm-12 margbot_10">
                <input type="text" name="state" placeholder="State" value="<?php if(isset($this->session->userdata['userdata']['state'])) echo $this->session->userdata['userdata']['state']?>" class="form-control" id="state" >
              </div>
