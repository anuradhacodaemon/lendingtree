<div class="form-main clearfix">
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 margbot_10">
          <input type="text" name="address" placeholder="Address"
            ...
            class="form-control width_100" id="address">
        ...
        <div class="col-xs-12 col-sm-4 margbot_10">
          <input type="text" name="zip" placeholder="Zip"
            ...
            class="form-control width_100" id="zip" maxlength="5">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 margbot_10">
          <select class="form-control width_100" style="width:auto;" name="state" id="state"
            onchange="get_city($(this).val())">
            <option value="">Select State</option>
            <?php foreach ($state as $k => $v) { ?>
            <option value="<?php echo $v['id']; ?>"
              <?php if (isset($this->session->userdata['state'])) if ($this->session->userdata['state'] == $v['id']) echo 'selected'; ?>>
        ...
        <div class="col-xs-12 col-sm-6 margbot_10">
          <select class="form-control width_100" name="city" id="city" style="width:auto;">
            ...
            <option value="<?php echo $v['id']; ?>"
              <?php if (isset($this->session->userdata['city'])) if ($this->session->userdata['city'] == $v['id']) echo 'selected'; ?>>
              <?php echo $v['name']; ?></option>
            <?php } ?>
          </select>
