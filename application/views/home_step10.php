  ...
  <div class="container" id="containerrefinance">
    <div class="form-main clearfix">
      ...
      <div class="slider-box">
        <input id="ex6" name="remaining_mortgage_bal" type="text" data-slider-min="10000" data-slider-max="100000"
          data-slider-step="500" data-slider-value="<?php
                        if (isset($this->session->userdata['remaining_mortgage_bal']))
                            echo $this->session->userdata['remaining_mortgage_bal'];
                        else
                            echo '10000';
    ...
    <div class="col-xs-12 col-sm-12 radio">
      <button type="button" class="button" onclick="home_step10()">Continue
