        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-main clearfix">
                    ...
                    <span id="ex6CurrentSliderValLabel" class="top-value">$ <label id="ex6SliderVal"><?php
                            if (isset($this->session->userdata['remaining_mortgage_bal']))
                                echo $this->session->userdata['remaining_mortgage_bal'];
                            else
                                echo '10000';
                            ?></label> to  $ <label id="ex6SliderVal2"><?php
                            if (isset($this->session->userdata['remaining_mortgage_bal']))
                                echo $this->session->userdata['remaining_mortgage_bal'] + 500;
                            else
                                echo '10500';
                            ?></label></span>
                    <div class="clearfix"></div>
                    <div class="slider-box">
                        <input id="ex6"  name="remaining_mortgage_bal" type="text" data-slider-min="10000" data-slider-max="100000" data-slider-step="500" data-slider-value="<?php
                        if (isset($this->session->userdata['remaining_mortgage_bal']))
                            echo $this->session->userdata['remaining_mortgage_bal'];
                        else
                            echo '10000';
                        ?>"/> 
                        <span class="min-value">$10,000  or less &nbsp;</span>
                ...
                <div class="col-xs-12 col-sm-12 radio">
                    <button type="button" class="button" onclick="home_step10()">Continue<span class="continueIcon sprites"></span></button>
