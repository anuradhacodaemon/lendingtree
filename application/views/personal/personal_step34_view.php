        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-main clearfix">
                    ...
                    <label class="control-label">I represent that everything i have stated in this application is
                        correct and complete to the best of my knowledge. you are authorized to check my (our) credit
                        history, and to answer questions about your credit history with me. (us).</label>
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="check">
                                    <div class="col-xs-12 col-sm-1 margbot_10">
                                        <input type="checkbox" name="co_i_represnt_accurate" value="consent" <?php if (isset($this->session->userdata['cosigner_i_represent_everything_correct'])) {
                                                                                                                    if ($this->session->userdata['cosigner_i_represent_everything_correct'] == 'Y') echo 'checked="checked"';
                                                                                                                    else echo '';
