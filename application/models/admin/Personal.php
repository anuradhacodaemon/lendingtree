...
class Personal extends CI_Model {
    ...
    public function get_user($id = 0, $limit, $start, $filterData, $sortData = "") {
        ...
        $this->db->from(PERSONALLOANS . ' as user');
...
//$this->db->select('id,name');
    ...
    public function get_column_name() {
        $sql = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='" . PERSONALLOANS . "'";
    ...
    public function updateStatus($lendid, $status) {
        ...
        $this->db->update(PERSONALLOANS, $userData);
