...
class Auto extends CI_Controller {
    ...
    */
    ...
    public function get_r_city($state_id = 0) {

        $city = $this->loan_model->get_city($state_id);
        echo json_encode($city);
    }

    public function get_co_p_city($state_id = 0) {

        $city = $this->loan_model->get_city($state_id);
        echo json_encode($city);
    }

    public function get_co_r_city($state_id = 0) {
    ...
    public function auto_step()
    {
        ...
        {
            $rules = array(
                array('field'=>'p_req_amt','label'=>'Requested Amount','rules'=>'required')
                );
            $this->form_validation->set_rules($rules);
            if ($this->form_validation->run() == true) 
            {
    ...
    {
        $this->load->view('default/mccu/auto/auto_step18_1_view');
    }
    ...
    {
        $this->load->view('default/mccu/auto/auto_step23_1_view');
    }
