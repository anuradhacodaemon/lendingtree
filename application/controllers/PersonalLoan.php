...
class PersonalLoan extends CI_Controller 
{
    ...
    */
    public function auto_step()
    {
        ...
        {
            $rules = array(
                array('field'=>'cosigner_monthly_income_pre_tax','label'=>'List Income Source','rules'=>'required'),array('field'=>'co_total_dependent','label'=>'Cosigner Total Dependent','rules'=>'required')
                );
    ...
    {
        $this->load->view('default/mccu/personal/personal_step27_1_view');
    }
    ...
    */
    ...
    public function unsetArrays($arr)
    {
        $unset_array = ['panel', '__ci_last_regenerate', 'type', 'address_p', 'p_country', 'p_street_line', 'p_zip_code',
                    ...
                    'p_cosigner_relatives_address', 'co_r_country', 'co_r_street_line', 'co_r_zip_code',
