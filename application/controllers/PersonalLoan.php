...
class PersonalLoan extends CI_Controller 
{
    ...
    */
    public function auto_step()
    {
        ...
        {
            $rules = array(
                array('field'=>'cosigner_monthly_income_pre_tax','label'=>'List Income Source','rules'=>'required|numeric'),array('field'=>'co_total_dependent','label'=>'Cosigner Total Dependent','rules'=>'required')
                );
