...
function home_step1(id) {
    ga('send', 'event', 'spececity', 'home loan', 'home_step1');
...
function home_step2(id) {
    ga('send', 'event', 'spececity', 'home loan', 'What type of home loan are you looking for');
...
function home_step3(id) {
    ga('send', 'event', 'spececity', 'home loan', 'What type of property are you refinancing');
    $.ajax({
        type: "GET",
...
function home_step4(id) {
    ...
    ga('send', 'event', 'spececity', 'home loan', 'How will this property be used');
    $.ajax({
        type: "GET",
...
function home_step41(id) {
    ...
    ga('send', 'event', 'spececity', 'home loan', 'When do you plan to buy a home');
    $.ajax({
        type: "GET",
...
function homestep25() {
    ga('send', 'event', 'spececity', 'home loan', 'Gross Pre-Tax Monthly Income');
...
function home_step5() {
    ga('send', 'event', 'spececity', 'home loan', 'ZIP code of the property');
...
function home_step6() {
    ga('send', 'event', 'spececity', 'home loan', 'estimate value of the property');
...
function home_step7() {
    ga('send', 'event', 'spececity', 'home loan', 'What is the remaining 1st mortgage balance');
...
function home_step8() {
    ga('send', 'event', 'spececity', 'home loan', 'second mortgage - yes');
...
function home_step9() {
    ga('send', 'event', 'spececity', 'home loan', 'second mortgage - NO');
...
function home_step10() {
    ga('send', 'event', 'spececity', 'home loan', 'What is the remaining balance on the 2nd mortgage');
    $.ajax({
        type: "GET",
...
function home_step11() {
    ga('send', 'event', 'spececity', 'home loan', 'Would you like to borrow additional cash');
...
function home_step111(id) {
    ga('send', 'event', 'spececity', 'home loan', 'Did you close on your mortgage');
...
function home_step12(id) {
    ga('send', 'event', 'spececity', 'home loan', 'Estimate your credit score');
...
function home_step13() {
    ga('send', 'event', 'spececity', 'home loan', 'Date Of Birth');
...
function home_step14() {
    ga('send', 'event', 'spececity', 'home loan', 'Have you or your spouse served in the military - Yes');
...
function home_step15() {
    ga('send', 'event', 'spececity', 'home loan', 'Have you or your spouse served in the military - NO');
...
function home_step16(id) {
    ga('send', 'event', 'spececity', 'home loan', 'Do you currently have a VA loan');
...
function home_step17() {
    ga('send', 'event', 'spececity', 'home loan', 'Have you had a bankruptcy or foreclosure in the last 7 years-NO');
...
function home_step171() {
    ga('send', 'event', 'spececity', 'home loan', 'How long ago was the bankruptcy');
...
function home_step172() {
    ga('send', 'event', 'spececity', 'home loan', 'How long ago was the foreclosure');
...
function home_step18() {
    ga('send', 'event', 'spececity', 'home loan', 'Have you had a bankruptcy or foreclosure in the last 7 years-bankruptcy');
...
function home_step19() {
    ga('send', 'event', 'spececity', 'home loan', 'Have you had a bankruptcy or foreclosure in the last 7 years-Forcloser');
...
function home_step20() {
    ga('send', 'event', 'spececity', 'auto loan', 'Have you had a bankruptcy or foreclosure in the last 7 years-Both');
...
function home_step22() {
    ga('send', 'event', 'spececity', 'home loan', 'current street address');
...
function home_step23() {
    ga('send', 'event', 'spececity', 'home loan', 'Customer Details');
...
function home_step24() {
    ga('send', 'event', 'spececity', 'home loan', 'Submit');
