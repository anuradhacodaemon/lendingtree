    ...
    function getFormId(form)
    {
       ...
       // alert('you are1');
        ...
        if(step == 1)
        {
            ...
            window.history.pushState({id:1}, "Title", base_url + "personalLoan?step=1");
        }
        /*if(step == 2)
        {
            var selected_marital_status = $('input[name="req_amt"]:checked').val();
            formData.append('req_amt', selected_marital_status);
            window.history.pushState({id:2}, "Title", base_url + "personalLoan?step=2");
        }*/
        if(step == 4 || step == 21)
        {
            if(step == 4)
...
{   
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:3}, "Title", base_url + "personalLoan?step=3");
            $('#container').html(data);                
        }
    });
}
...
{   
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:4}, "Title", base_url + "personalLoan?step=4");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:5}, "Title", base_url + "personalLoan?step=5");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:6}, "Title", base_url + "personalLoan?step=6");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:7}, "Title", base_url + "personalLoan?step=7");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:8}, "Title", base_url + "personalLoan?step=8");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:9}, "Title", base_url + "personalLoan?step=9");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:10}, "Title", base_url + "personalLoan?step=10");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:11}, "Title", base_url + "personalLoan?step=11");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:11.1}, "Title", base_url + "personalLoan?step=11.1");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:12}, "Title", base_url + "personalLoan?step=12");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:13}, "Title", base_url + "personalLoan?step=13");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:14}, "Title", base_url + "personalLoan?step=14");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:15}, "Title", base_url + "personalLoan?step=15");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:16}, "Title", base_url + "personalLoan?step=16");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:17}, "Title", base_url + "personalLoan?step=17");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:18}, "Title", base_url + "personalLoan?step=18");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:19}, "Title", base_url + "personalLoan?step=19");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:20}, "Title", base_url + "personalLoan?step=20");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:21}, "Title", base_url + "personalLoan?step=21");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:22}, "Title", base_url + "personalLoan?step=22");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:22.1}, "Title", base_url + "personalLoan?step=22.1");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:24}, "Title", base_url + "personalLoan?step=24");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:25}, "Title", base_url + "personalLoan?step=25");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:26}, "Title", base_url + "personalLoan?step=26");
            $('#container').html(data);                
        }
    });
}

function personal_step27_1()
{  
    $('#step_count').val(27.1);
    $.ajax({
        type: "GET",
        url:  base_url + "personalLoan/step27_1",
        success: function (data)
        {      
            window.history.pushState({id:27.1}, "Title", base_url + "personalLoan?step=27.1");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:27}, "Title", base_url + "personalLoan?step=27");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:28}, "Title", base_url + "personalLoan?step=28");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:29}, "Title", base_url + "personalLoan?step=29");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:30}, "Title", base_url + "personalLoan?step=30");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:31}, "Title", base_url + "personalLoan?step=31");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:32}, "Title", base_url + "personalLoan?step=32");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:32.1}, "Title", base_url + "personalLoan?step=32.1");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:33}, "Title", base_url + "personalLoan?step=33");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:34}, "Title", base_url + "personalLoan?step=34");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:35}, "Title", base_url + "personalLoan?step=35");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:36}, "Title", base_url + "personalLoan?step=36");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:37}, "Title", base_url + "personalLoan?step=37");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:38}, "Title", base_url + "personalLoan?step=38");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:39}, "Title", base_url + "personalLoan?step=39");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:40}, "Title", base_url + "personalLoan?step=40");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:41}, "Title", base_url + "personalLoan?step=41");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:42}, "Title", base_url + "personalLoan?step=42");
            $('#container').html(data);                
        }
    });
}
...
{  
    ...
    $.ajax({
        ...
        success: function (data)
        {      
            window.history.pushState({id:43}, "Title", base_url + "personalLoan?step=43");
            $('#container').html(data);                
        }
    });
}
