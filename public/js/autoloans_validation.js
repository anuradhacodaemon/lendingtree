...
function selectedVehicle(step, value)
{
    if(step == 44)
    {
        ...
        var form = document.getElementById('vehicle_info');
...
{   
    ...
    $.ajax({
        ...
        success: function (data)
        {    
            window.history.pushState({id:44}, "Title", base_url + "auto?step=44");
            $('#container').html(data);                
        }
    });
}
function autoloan_step44_1()
{   
    $('#step_count').val(44.1);
    $.ajax({
        type: "GET",
        ...
        success: function (data)
        {    
            window.history.pushState({id:44.1}, "Title", base_url + "auto?step=44.1");
            $('#container').html(data);                
        }
    });
}
...
function autoloan_step27_1()
{  
    $('#step_count').val(27.1);
    $.ajax({
        type: "GET",
        url:  base_url + "auto/step27_1",
        success: function (data)
        {      
            window.history.pushState({id:27.1}, "Title", base_url + "auto?step=27.1");
            $('#container').html(data);                
        }
    });
}
