...
function refinancestep1() {
    ga('send', 'event', 'coastal', 'auto refinance', 'How Much Do Currently Owe');
...
function refinancestep2() {
    ga('send', 'event', 'coastal', 'auto refinance', 'What Is Your Current Monthly Payment');
    $.ajax({
        type: "GET",
...
function refinancestep3() {
    ga('send', 'event', 'coastal', 'auto refinance', 'Vehicle VIN Number');
    var RE = /^[A-Za-z]+$/;
    var RE1 = /^\d*\.?\d*$/;
...
function refinancestep4() {
    ga('send', 'event', 'coastal', 'auto refinance', 'custmer details');
...
function refinancestep5() {
    ga('send', 'event', 'coastal', 'auto refinance', 'Date Of Birth');
     var regex = /^[0-9]{3}\-?[0-9]{2}\-?[0-9]{4}$/;
...
function refinancestep7() {
    ga('send', 'event', 'coastal', 'auto refinance', 'Submit');
