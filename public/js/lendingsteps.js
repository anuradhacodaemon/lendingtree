...
function step1(id) {
    ga('send', 'event', 'bay-equity', 'auto loan', 'type of loan');
...
function step3(id) {
    ga('send', 'event', 'bay-equity', 'auto loan', 'Requested Amount');
    $.ajax({
        type: "GET",
...
function step4() {
    ga('send', 'event', 'bay-equity', 'auto loan', 'Current Employer');
    var RE = /^[A-Za-z]+$/;
    var RE1 = /^\d*\.?\d*$/;
...
function step5() {
    ga('send', 'event', 'bay-equity', 'auto loan', 'Pre-Tax Monthly Income');
    var RE = /^\d*\.?\d*$/;
...
function step6() {
    ga('send', 'event', 'bay-equity', 'auto loan', 'Your Details');
...
function step7(){
    ga('send', 'event', 'bay-equity', 'auto loan', 'When Were You Born');
     var regex = /^[0-9]{3}\-?[0-9]{2}\-?[0-9]{4}$/;
...
function step8() {
    ga('send', 'event', 'bay-equity', 'auto loan', 'Submit');
