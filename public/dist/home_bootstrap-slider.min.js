        ...
        c(a)
            ...
            function (a) {
                ...
                if (d = function (a, b) {
                    ...
                    getValue: function () {
                        if (this._state.value[0])
                        {
                           
                            
                            document.getElementById("ex6SliderVal").textContent = numberWithCommas(this._state.value[0]);
                            document.getElementById("ex6SliderVal2").textContent = numberWithCommas(this._state.value[0]+500);
                        }
